...
from keras.layers import Conv1D, MaxPooling1D, GlobalMaxPooling1D, Conv2D, MaxPooling2D
...
weights_filename = 'weights/ddpg_weights_4coins.h5f'
checkpoint_weights_filename = 'weights/ddpg_weights_4coins_{step}.h5f'
log_filename = 'logs/ddpg_log_4coins.json'
